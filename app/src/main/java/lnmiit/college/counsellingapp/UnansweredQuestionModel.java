...
public class UnansweredQuestionModel {
    ...
    public UnansweredQuestionModel(String question_id, String question_text, String asked_by, Map<String, String> faculty_answers, String tag, Date date, String userid, boolean answered) {
        this.question_id = question_id;
        this.question_text = question_text;
        this.asked_by = asked_by;
        this.faculty_answers = faculty_answers;
